...
const Experience = () => {
  const jobs: Job[] = [
    ...
    },
    {
      ...
      images: [photoshopicon, illustratoricon, aftereffectsicon, premiereproicon], // Updated to use actual image variables
      points: ['Designed Social Media Content, Poster for Occasions and Events, Banners, Advertisements.',
