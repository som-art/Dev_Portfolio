      ...
      max-w-6xl px-10 justify-evenly mx-auto items-center">
        ...
        <div className="space-y-10 px-0 md:px-10">
            <h4 className="text-xl lg:text-4xl font-light tracking-wide">
                <span className="inline relative">Introducing Myself
                <motion.span 
                    initial={{ opacity: 0,
                    width: 0,
                    ...
                    viewport={{once: true}}
                    className="absolute left-0 bottom-[-3px] border-b-2"></motion.span>
                </span>
            </h4>
            <p className="text-sm md:text-lg lg:text-lg text-justify">
            Graduate of computer science pursuing Masters Degree . Looking for a role where I can grow and learn from experienced team
